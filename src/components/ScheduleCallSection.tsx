...
const ScheduleCallSection = () => {
  ...
  return (
    <section className="relative w-full py-24 lg:py-32 bg-[#FDFCF8] px-6 lg:px-20 overflow-hidden font-sans">
      {/* Structural Background Lines */}
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <div className="absolute top-1/2 left-0 w-full h-[1px] bg-gray-200" />
        <div className="absolute top-[30%] left-0 w-[20%] h-[1px] bg-gray-200" />
        <div className="absolute top-[70%] left-0 w-[20%] h-[1px] bg-gray-200" />
        <div className="absolute top-[30%] right-0 w-[25%] h-[1px] bg-gray-200" />
        <div className="absolute top-[70%] right-0 w-[25%] h-[1px] bg-gray-200" />
        <div className="absolute top-[30%] left-[20%] w-[1px] h-[40%] bg-gray-200" />
        <div className="absolute top-[30%] right-[25%] w-[1px] h-[40%] bg-gray-200" />
      </div>

      <div className="max-w-7xl mx-auto relative z-10">
        {/* Header Section */}
        <div className="text-center mb-16 space-y-4">
          <h2 className="text-4xl lg:text-6xl font-extrabold text-gray-900 tracking-tight leading-tight">
            Ready to Take This Forward? <br />
            Let’s{" "}
        ...
        <div className="grid grid-cols-12 items-center gap-4 relative">
          ...
          <div className="col-span-12 lg:col-span-6">
            <motion.div
              ...
              className="relative aspect-video rounded-[40px] overflow-hidden border-[12px] border-white shadow-2xl shadow-blue-900/10 group bg-gray-100"
            >
              <img
              ...
              <div className="absolute bottom-10 left-1/2 -translate-x-1/2 flex gap-4 w-max">
                <button className="flex items-center gap-2 bg-white text-gray-900 px-6 py-3 rounded-full font-bold text-[13px] shadow-lg hover:bg-gray-50 transition-all cursor-pointer">
                  <CalendarDays size={16} className="text-[#2F85EA]" />
                  Schedule A Call
                </button>
                <button
                  className={`${brandGradient} text-white px-6 py-3 rounded-full font-bold text-[13px] shadow-lg hover:opacity-90 transition-all cursor-pointer`}
                >
                  Get In Touch
                </button>
              </div>
        ...
        <div className="flex flex-col gap-4 mt-12 lg:hidden">
          <button className="flex items-center justify-center gap-2 border-2 border-gray-900 px-8 py-4 rounded-full font-bold text-gray-900">
            Schedule A Call
          </button>
          <button
            className={`${brandGradient} text-white px-8 py-4 rounded-full font-bold shadow-lg`}
          >
            Get In Touch
          </button>
        </div>
